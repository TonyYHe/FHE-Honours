...
from orion.core.region_cir_replay import (
    build_r18_stage4_gs256_prototype_python_microbench,
    build_r18_stage4_python_microbench,
)


def main() -> int:
    baseline = build_r18_stage4_python_microbench()
    prototype = build_r18_stage4_gs256_prototype_python_microbench()
    payload = {
