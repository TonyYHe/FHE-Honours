...
INPUT_LABELS = {
    "u22_192_base32_encoder": "192x192",
    "u22_224_base32_encoder": "224x224",
    "u22_384x288_base32_encoder": "384x288",
    "u22_384_base32_encoder": "384x384",
}
...
def update_doc(doc_path: Path, result_dir: Path) -> None:
    ...
    text = _replace_block(text, "U22_DIM32_ENCODER_BASELINE_TABLE", _markdown_table(headers, rows))
...
def main() -> int:
    ...
    parser.add_argument("--result-dir", type=Path, default=Path(".tmp/results/u22_dim32_encoder_baseline"))
